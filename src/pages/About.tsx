        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center mb-24">
          ...
          >
            ...
            <p className="text-lg text-dark-brown/70 font-light mb-6 leading-relaxed">
              Homes By Kulkarni is a premier interior design studio dedicated to creating personalized, elegant environments. We believe that your home should be a reflection of your evolving story.
            </p>
